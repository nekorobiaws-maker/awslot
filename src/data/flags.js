 ...
 * U48(2026-08-15)で通常設定そのものが従来の2倍になったので、
 * 甘スロは **従来比4倍**(レア役合計 1/6.2)になる。
...
export const NORMAL_FLAGS = {
  ...
  flags: [
     ...
     */
    { id: 'WEAK_CHERRY',   name: '弱チェリー(IAM)',     denom: 25,   payout: 2, rare: true },
    { id: 'STRONG_CHERRY', name: '強チェリー(IAM金)',   denom: 125,  payout: 2, rare: true },
    { id: 'MELON',         name: 'スイカ(S3)',          denom: 50,   payout: 5, rare: true },
    { id: 'CHANCE',        name: 'チャンス目(Lambda)',  denom: 90,   payout: 2, rare: true },
    { id: 'SHARK',         name: 'サメ揃い(BAR)',       denom: 600,  payout: 3, rare: true },
    { id: 'GHOST',         name: 'ゴースト揃い(幽霊7)', denom: 3000, payout: 0, rare: true },
