...
export const HERO_HOMES = {
   ...
   */
  /*
   * 2026-08-16 検証指摘 V80-12「ヒーローが帯に重なる」。
   * 万歳ポーズは腕が箱の上端まで伸びるので、中心 y180 だと拳が 5枠(〜y126)へ
   * 食い込んでいた。中心を 10px 下げて、体は y142〜238 = 枠の下・座布団の上に収める。
   */
  HERO_RUSH: { x: 352, y: 190, scale: 0.58 },
