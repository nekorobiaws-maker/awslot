 ...
 * 冠の上端(src 30〜64)だけビューポート外へ逃がしている。
 */
const CABINET2_BANDS = [
  [30, 170, -26.4, 80],        // 冠 + AWSLOTタイトル(等倍0.76。上端は画面外へ)
  [170, 578, 80, 420.96],      // 液晶窓 → Canvas #lcd(縦0.836)
  [578, 656, 420.96, 480.24],  // 液晶とリールの間の金属帯(等倍0.76)
  [656, 872, 480.24, 658.08],  // リール窓 → Canvas #reels(縦0.823)
  [872, 1290, 658.08, 975.76], // 操作デッキ + 下部の幽霊パネル(等倍0.76)
  [1290, 1448, 975.76, 1080],  // 台座(平坦なので詰める)
];
